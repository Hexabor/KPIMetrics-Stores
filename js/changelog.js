...
const Changelog = [
    {
        ...
        items: [
            ...
            { type: 'change', text: 'Editor de Familias de categorias rediseñado como master-detail: arriba los chips de familias con su contador de categorias y badge factory/custom; clic en un chip activa esa familia abajo y muestra sus categorias en una nube de chips. Cada categoria-chip tiene "Mover a..." (otra familia o Sin mapear) y un "↺" para restaurar a factory si esta modificada. Selector "+ Anadir categoria" al pie con autocompletado agrupado (Sin mapear primero, luego categorias de otras familias). Adios a la tabla con causa y efecto separados por toda la pantalla' },
            { type: 'new', text: 'Pseudo-familia "Sin mapear" siempre visible en la fila de chips (chip con borde discontinuo): contiene las categorias sin familia asignada y permite reasignarlas desde alli con el selector "Mover a..."' },
